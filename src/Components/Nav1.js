    ...
    return (
        <div className="nav1 ">
            ...
            <div className="nav1-left">
                <FaBars className="menu-icon" onClick={toggleNav2} /> {/* Menu icon */}
            ...
            <div className="nav1-center">
                <h1 className="text-center" style={{fontFamily:'Oswald, sans-serif',marginLeft:'100px'}}>G  O  Y  A  R  D <br /> <h5 style={{ color: "#ccc", fontSize: "15px" }}>P A R I S</h5></h1>
            </div>
